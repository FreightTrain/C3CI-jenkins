require_relative '../../../lib/jenkins/tasks/add_github_ssh_host_key'

module Jenkins
  module Tasks
    describe AddGithubSshHostKey do

      describe '#initialize' do
        it 'raises if the path to known_hosts is not specified' do
          expect { AddGithubSshHostKey.new(nil) }.to raise_error(ArgumentError,
      ...
      describe "#execute" do
        ...
        let(:task) { AddGithubSshHostKey.new('/home/vcap/.ssh/known_hosts') }
